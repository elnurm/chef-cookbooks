...
CHEF_SERVER_ENDPOINT="chef-server-scd73a2xpwjjqjby.eu-central-1.opsworks-cm.io" # The FQDN of your Chef Server
REGION="eu-central-1" # Region of your Chef Server (Choose one of our supported regions - us-east-1, us-east-2, us-west-1, us-west-2, eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2)
